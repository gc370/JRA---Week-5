% script for testing against the actual radius where r(t) = sqrt(1-2t) t <=  0.5

w5

[matrixx1,matrixy1] = CurveshorteningflowW5test2(numberofpointsinrho,numberofpointsintime,tau);
[matrixx2,matrixy2] = CurveshorteningflowW5test2(numberofpointsinrho*2,numberofpointsintime*2,tau);
[matrixx3,matrixy3] = CurveshorteningflowW5test2(numberofpointsinrho*4,numberofpointsintime*4,tau);
[matrixx4,matrixy4] = CurveshorteningflowW5test2(numberofpointsinrho*8,numberofpointsintime*8,tau);
