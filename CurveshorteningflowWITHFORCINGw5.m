function [matrixx,matrixy] = CurveshorteningflowWITHFORCINGw5(numberofpointsinrho,numberofpointsintime,tau)
        ...
        j=1;
            ...
            %-------------------------------------------------------------%
                    ...
                    p = @(j) 2/(sqrt(matrixx(j,2)^2 + (matrixy(j,2)^2)));
                    ...
                    newiterationx = invertedmatrix*(newvecx + p(j)*RHSforcingvecx);
                    ...
                    newiterationy = invertedmatrix*(newvecy + p(j)*RHSforcingvecy);
